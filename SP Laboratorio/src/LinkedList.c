...
int ll_indexOf(LinkedList* this, void* pElement)
{
    ...
    if(this != NULL)
    {
    	...
    	{
    		pAuxiliarElement = ll_get(this, i);

    		if(pAuxiliarElement == pElement)
    		{
    			returnAux = i;
    			break;
    		}
...
int ll_containsAll(LinkedList* this,LinkedList* this2)
{
    ...
    if(this != NULL && this2 != NULL)
    {
    	...
    	for(i = 0; i < ll_len(this); i++)
    	{
    		...
    		if(pElement != NULL)
    		{
    			if(ll_contains(this2, pElement) == 0)
    			{
    				returnAux = 0;
    			}
    		}
...
LinkedList* ll_subList(LinkedList* this,int from,int to)
{
    ...
    if(this != NULL && from >= 0 && to <= ll_len(this) && from < to && to > from)
    {
...
La función “fn” devolverá 1 si ese ítem se debe agregar a la lista resultado o
0 si no debe agregarse.
La función “ll_filter” generará la nueva lista resultado,
...
/* Desarrollar la función ll_map en la biblioteca linkedList,
 * la cual recibirá la lista y una función.
